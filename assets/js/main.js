...
function navHighlighter()
{
    ...
    sections.forEach(current => {
        ...
        // corresopndind navigator linkWork, else remove it
        // - To know which link needs on sctive class, we use sectionId variable we are getting while looping through
